...
This allows us to simply refer to the `appName` variable any time we
...
Understanding what this program is trying to do is not obvious, to say
...
In JavaScript, most programmers use the **camel case** style, which
